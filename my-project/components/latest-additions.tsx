...
import { BookOpen, FileText, Video, Mic, Clock } from "lucide-react"
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {items.map((item, index) => (
            ...
            >
              <Link href={item.href}>
                <Card className="glass border-border hover:border-primary/40 transition-all duration-300 group h-full">
